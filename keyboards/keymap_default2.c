...
[0] = { /* Qwerty */
  ...
  {FUNC(5), KC_LCTL, KC_LALT, KC_LGUI, FUNC(2),    KC_SPC,   KC_SPC,    FUNC(1),   KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT}
...
[4] = { /* TENKEY */
  ...
  {KC_TRNS, KC_PSCR, KC_TRNS, KC_TRNS, KC_PSLS, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_TRNS, KC_TRNS, KC_TRNS},
  {KC_TRNS, KC_NUMLOCK, KC_TRNS, KC_TRNS, KC_PAST, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_TRNS, KC_TRNS, KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_PENT, KC_TRNS, KC_TRNS, KC_TRNS},
  {FUNC(5), KC_TRNS, KC_TRNS, KC_TRNS, FUNC(2), KC_P0,  KC_P0,   FUNC(1), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS}
}
};
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [5] = ACTION_LAYER_MOMENTARY(4),  // to TENKEY
